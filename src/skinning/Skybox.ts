 ...
 */
export class Skybox {
    // Static skybox geometry (shared for all skyboxes)
    private static positionsF32: Float32Array;
    private static indicesU32: Uint32Array;
    private static normalsF32: Float32Array;
    private static uvF32: Float32Array;
    ...
    private initializeGeometry(): void {
        ...
        positions.forEach((v: Vec4, i: number) => {
    ...
    public static uvFlat(): Float32Array {
        return Skybox.uvF32;
    }
}